...
typedef struct {
	...
	BranchAndFinancialInstitutionIdentification6 UltmtDbtr;
	BranchAndFinancialInstitutionIdentification6 Dbtr;
	...
	BranchAndFinancialInstitutionIdentification6 Cdtr;
	CashAccount38 CdtrAcct;
	BranchAndFinancialInstitutionIdentification6 UltmtCdtr;
...
typedef struct {
	...
	CreditTransferTransaction44 CdtTrfTxInf[];
	SupplementaryData1 SplmtryData[];
} FinancialInstitutionCreditTransferV09;
