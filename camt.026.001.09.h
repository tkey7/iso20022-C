...
typedef char ExternalUnableToApplyIncorrectData1Code;

// ExternalUnableToApplyMissingData1Code 
typedef char ExternalUnableToApplyMissingData1Code;
...
typedef struct {
	...
	Case5 Case;
	UnderlyingTransaction7Choice Undrlyg;
...
typedef struct {
	UnderlyingPaymentInstruction7 Initn;
	UnderlyingPaymentTransaction6 IntrBk;
