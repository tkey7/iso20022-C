...
typedef char ExternalPaymentGroupStatus1Code;

// ExternalPaymentTransactionStatus1Code 
typedef char ExternalPaymentTransactionStatus1Code;
...
typedef char ExternalStatusReason1Code;
...
typedef struct {
	GroupHeader91 GrpHdr;
	OriginalGroupHeader17 OrgnlGrpInfAndSts[];
	PaymentTransaction123 TxInfAndSts[];
...
typedef struct {
	...
	float OrgnlCtrlSum;
	char GrpSts;
	StatusReasonInformation12 StsRsnInf[];
...
typedef struct {
	...
	BranchAndFinancialInstitutionIdentification6 InstgAgt;
	BranchAndFinancialInstitutionIdentification6 InstdAgt;
	OriginalTransactionReference31 OrgnlTxRef;
	SupplementaryData1 SplmtryData[];
} PaymentTransaction123;
