...
// Authorisation1Code 
typedef char Authorisation1Code;
...
typedef char ExternalReturnReason1Code;
...
typedef struct {
	MandateRelatedInformation14 DrctDbtMndt;
...
typedef struct {
	...
	char DtOfSgntr;
	bool AmdmntInd;
	AmendmentInformationDetails13 AmdmntInfDtls;
	char ElctrncSgntr;
	char FrstColltnDt;
	char FnlColltnDt;
	Frequency36Choice Frqcy;
...
typedef struct {
	...
	char OrgnlMsgNmId;
	char OrgnlCreDtTm;
	PaymentReturnReason6 RtrRsnInf[];
} OriginalGroupHeader18;
...
typedef struct {
	...
	char PmtMtd;
	MandateRelatedData1Choice MndtRltdInf;
	RemittanceInformation16 RmtInf;
	...
	Purpose2Choice Purp;
	CreditTransferTransaction45 UndrlygCstmrCdtTrf;
} OriginalTransactionReference32;
...
// PaymentReturnV10 
typedef struct {
	GroupHeader90 GrpHdr;
	OriginalGroupHeader18 OrgnlGrpInf;
	PaymentTransaction118 TxInf[];
...
typedef struct {
	...
	BranchAndFinancialInstitutionIdentification6 InstgAgt;
	BranchAndFinancialInstitutionIdentification6 InstdAgt;
	TransactionParties8 RtrChain;
	PaymentReturnReason6 RtrRsnInf[];
	OriginalTransactionReference32 OrgnlTxRef;
	SupplementaryData1 SplmtryData[];
} PaymentTransaction118;
